...
| 3 | Every form field proofread rendered, logged out | **PASS, 2026-09-13** | https://devpost.com/software/day-thirty read from a fresh browser context: title, the exact tagline, all nine story sections (App Runner sentence and relevance paragraph included), 25 Built With tags with strands-agents, three Try it out links resolving to the repo, the write-up and the live demo, the video embedded, eight gallery captions with no stray text. No drafting prose anywhere on the page. |
...
| 5 | Public-access check, logged out | **PASS, gallery pending** | Repo 200 unauthenticated, clean clone green. Video plays (oEmbed and the embed on the project page). Project page 200 logged out. Live demo answers logged out. Gallery is still organiser-gated on 2026-09-13 ("haven't published this gallery yet"), which is the ordinary state and not a signal; search it for "Day Thirty" once it opens. |
...
4. Done 2026-09-13: submitted, project page proofread logged out. Only the gallery search remains, once the organisers publish it.
